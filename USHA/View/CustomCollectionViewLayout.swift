...
{
    //let numberOfColumns = DataProvider.sharedInstance.reportData.count + 2 //8
...
extension CustomCollectionViewLayout
{
    ...
    {
        if (DataProvider.sharedInstance.reportData.count == 0)
        {
            numberOfColumns =  1
        }
        else
        {
            numberOfColumns = DataProvider.sharedInstance.reportData.count + 2
        }
...
//        return CGSize(width: width, height: 30)
        ...
        let w = ((self.collectionView?.frame.width)! - 124) / 3
        
        switch columnIndex
        {
        case 0:
            return CGSize(width: 124, height: 42)
        default:
            return CGSize(width: w, height: 42)
        }
    }
