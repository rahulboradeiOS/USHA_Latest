...
//    }
    ...
    @objc fileprivate var _validateOnCharacterChanged  = false
...
//    open func addcharecterLimit(_ limit:Int)
//    {
//        let maxLength = 4
...
//        strLengthValidationMsg = msg
    ...
    @objc open func showErrorIconForMsg(_ msg:String)
    {
...
class TextFieldValidatorSupport : NSObject, UITextFieldDelegate
{
    ...
    func textField(_ textField: UITextField, shouldChangeCharactersIn range: NSRange, replacementString string: String) -> Bool {
        ...
        if validateOnCharacterChanged {
            ...
            (textField as! SkyFloatingLabelTextField).perform(#selector(getter: SkyFloatingLabelTextField._validateOnCharacterChanged), with: nil, afterDelay:0.1)
        }
        else
        {
