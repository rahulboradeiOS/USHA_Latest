...
class NotInSystemTransactionPopup: UIViewController {
...
extension NotInSystemTransactionPopup: UITableViewDelegate, UITableViewDataSource
{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell
    {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "cell", for: indexPath) as! NotInSystemTransactionPopupTableViewCell
...
class NotInSystemTransactionPopupTableViewCell : UITableViewCell
{
